...
enum smpc_state
{
     ...
     **------------------------------------**/
     // wait for generation of local public key
     SMPC_PAIRING_SC_W4_LOCAL_PUBLIC_KEY,
     // wait for reception of local public key
...
/**
 ****************************************************************************************
 * @brief Handle reception of a Public key read from HCI
 *
 * @param[in] conidx        Connection Index
 * @param[in] pub_key_x     X coordinate of Public Key
 * @param[in] pub_key_y     Y coordinate of Public Key
 ****************************************************************************************
 */
void smpc_handle_pubkey_read_complete(uint8_t conidx, const uint8_t* pub_key_x, const uint8_t* pub_key_y);
