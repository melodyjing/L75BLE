...
/**
 ****************************************************************************************
 * Retrieve Advertising handle according to actvity index
 *
 * @param actv_idx Activity index
 *
 * @return Advertising handle if exists else GAP_INVALID_CONIDX
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * Retrieve Periodic sync handle according to actvity index
 *
 * @param actv_idx Activity index
 *
 * @return Periodic sync handle if exists else GAP_INVALID_CONHDL
 ****************************************************************************************
 */
