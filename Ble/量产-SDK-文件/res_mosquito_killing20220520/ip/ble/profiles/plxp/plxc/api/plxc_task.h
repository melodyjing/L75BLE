...
enum plxc_desc_ids
{
    /// PLXP SPOT-Measurement Characteristic Clien Configuration
    PLXC_DESC_SPOT_MEASUREMENT_CCC = 0,
    /// PLXP Continuous Measurement Characteristic Clien Configuration
    PLXC_DESC_CONT_MEASUREMENT_CCC,
    /// PLXP Record Access Control Point Characteristic Clien Configuration
    PLXC_DESC_RACP_CCC,
...
enum plxc_op_codes
{
    ...
    PLXC_OP_CODE_WRITE_CCC           = 5,
    PLXC_OP_CODE_WRITE_RACP          = 6,
    PLXC_OP_CODE_GATTC_REGISTER      = 7,
};
