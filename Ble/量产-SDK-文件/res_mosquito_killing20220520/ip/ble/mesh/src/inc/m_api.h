...
/**
 ****************************************************************************************
 * @brief Inform the application about new or deleted group (application key)
 *
 * @param[in] added         True if group has been added, else false
 * @param[in] appkey_id     AppKey ID
 * @param[in] app_key_lid   Application key local index
 ****************************************************************************************
 */
void m_api_send_group_update_ind(bool added, uint16_t appkey_id, m_lid_t app_key_lid);
