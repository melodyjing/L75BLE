...
enum mm_tb_state_cfg
{
    ...
    MM_TB_STATE_CFG_CB_BIT = CO_BIT(MM_TB_STATE_CFG_CB_POS),
};
...
enum mm_tb_state_mdl_info
{
    ...
    MM_TB_STATE_MDL_INFO_MAIN_BIT = CO_BIT(MM_TB_STATE_MDL_INFO_MAIN_POS),

    /// Publication are enabled for the model
    MM_TB_STATE_MDL_INFO_PUBLI_POS = 1,
    MM_TB_STATE_MDL_INFO_PUBLI_BIT = CO_BIT(MM_TB_STATE_MDL_INFO_PUBLI_POS),
 ...
 ****************************************************************************************
 */
typedef uint16_t (*mm_cli_get_cb)(mm_tb_state_mdl_env_t *p_env, m_lid_t app_key_lid, uint16_t dst,
                                  uint16_t get_info);
 ...
 ****************************************************************************************
 */
typedef uint16_t (*mm_cli_set_cb)(mm_tb_state_mdl_env_t *p_env, m_lid_t app_key_lid, uint16_t dst,
 ...
 ****************************************************************************************
 */
typedef uint16_t (*mm_cli_transition_cb)(mm_tb_state_mdl_env_t *p_env, m_lid_t app_key_lid, uint16_t dst,
