 ...
 ****************************************************************************************
 */
uint16_t mm_genc_loc_set_global(mm_tb_state_mdl_env_t *p_env, m_lid_t app_key_lid, uint16_t dst,
 ...
 ****************************************************************************************
 */
uint16_t mm_genc_loc_set_local(mm_tb_state_mdl_env_t *p_env, m_lid_t app_key_lid, uint16_t dst,
 ...
 ****************************************************************************************
 */
uint16_t mm_genc_prop_get(mm_tb_state_mdl_env_t *p_env, m_lid_t app_key_lid, uint16_t dst,
 ...
 ****************************************************************************************
 */
uint16_t mm_genc_prop_set(mm_tb_state_mdl_env_t *p_env, m_lid_t app_key_lid, uint16_t dst, uint8_t set_info,
