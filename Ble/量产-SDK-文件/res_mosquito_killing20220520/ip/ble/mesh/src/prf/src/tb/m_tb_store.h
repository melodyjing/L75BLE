...
enum m_tb_store_nvds_tag
{
    ...
    /// Default TTL
    NVDS_TAG_MESH_DEFAULT_TTL           = NVDS_TAG_MESH_UNICAST_ADDR + 1,
    NVDS_LEN_MESH_DEFAULT_TTL           = 1,

    /// Secure Network Beacon
    NVDS_TAG_MESH_SECURE_BCN            = NVDS_TAG_MESH_DEFAULT_TTL + 1,
    NVDS_LEN_MESH_SECURE_BCN            = 1,

    /// Network Transmit
    NVDS_TAG_MESH_NETWORK_TX            = NVDS_TAG_MESH_SECURE_BCN + 1,
    NVDS_LEN_MESH_NETWORK_TX            = 1,

    /// Relay
    NVDS_TAG_MESH_RELAY                 = NVDS_TAG_MESH_NETWORK_TX + 1,
    NVDS_LEN_MESH_RELAY                 = 2,

    /// GATT Proxy
    NVDS_TAG_MESH_GATT_PROXY            = NVDS_TAG_MESH_RELAY + 1,
    NVDS_LEN_MESH_GATT_PROXY            = 1,

    /// Friend
    NVDS_TAG_MESH_FRIEND                = NVDS_TAG_MESH_GATT_PROXY + 1,
    NVDS_LEN_MESH_FRIEND                = 1,

    /// Device Key
    NVDS_TAG_MESH_DEV_KEY               = NVDS_TAG_MESH_FRIEND + 1,
    NVDS_LEN_MESH_DEV_KEY               = 16,

    /// IV - Sequence Number
    NVDS_TAG_MESH_IV_SEQ                = NVDS_TAG_MESH_DEV_KEY + 1,
    NVDS_LEN_MESH_IV_SEQ                = 14,

    /// Network Key Information
    NVDS_TAG_MESH_NET_KEY_FIRST         = NVDS_TAG_MESH_IV_SEQ + 1,
    NVDS_TAG_MESH_NET_KEY_LAST          = NVDS_TAG_MESH_NET_KEY_FIRST + M_TB_KEY_MAX_NB_NET - 1,
    NVDS_LEN_MESH_NET_KEY               = 36,

    /// Application Key Information
    NVDS_TAG_MESH_APP_KEY_FIRST         = NVDS_TAG_MESH_NET_KEY_LAST + 1,
    NVDS_TAG_MESH_APP_KEY_LAST          = NVDS_TAG_MESH_APP_KEY_FIRST + M_TB_KEY_MAX_NB_APP - 1,
    NVDS_LEN_MESH_APP_KEY               = 38,

    /// Publication Parameters
    NVDS_TAG_MESH_PUBLI_FIRST           = NVDS_TAG_MESH_APP_KEY_LAST + 1,
    NVDS_TAG_MESH_PUBLI_LAST            = NVDS_TAG_MESH_PUBLI_FIRST + M_TB_MIO_MODEL_NB - 1,
    NVDS_LEN_MESH_PUBLI                 = 32,

    /// Subscription Lists
    NVDS_TAG_MESH_SUBS_FIRST            = NVDS_TAG_MESH_PUBLI_LAST + 1,
    NVDS_TAG_MESH_SUBS_LAST             = NVDS_TAG_MESH_SUBS_FIRST + M_TB_MIO_MODEL_NB - 1,
    NVDS_LEN_MESH_SUBS                  = 255,

    /// Bindings
    NVDS_TAG_MESH_BINDINGS_FIRST        = NVDS_TAG_MESH_SUBS_LAST + 1,
