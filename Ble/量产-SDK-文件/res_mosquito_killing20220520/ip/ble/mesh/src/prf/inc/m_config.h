...
/// Default TTL to use for transmission - Cannot be set to 1
#define M_TTL_DEFAULT                        (11)

/// Number of advertising transmission to perform
#define M_ADV_NB_TX                          (2)
...
#define M_STORE_SEQ_OFFSET                   (1000)

/// Maximum number of sources address that can be stored by the Message Replay Protection Manager
#define M_REPLAY_ADDR_NB_DFLT                (5)
