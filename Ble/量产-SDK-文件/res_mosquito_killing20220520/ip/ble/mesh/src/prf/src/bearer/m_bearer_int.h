...
enum m_bearer_state
{
    ...
    M_BEARER_UPDATE_BIT   = CO_BIT(M_BEARER_UPDATE_POS),
    /// Indicate that bearer has paused its reception
    M_BEARER_RX_PAUSE_POS = 4,
    M_BEARER_RX_PAUSE_BIT = CO_BIT(M_BEARER_RX_PAUSE_POS),
    /// Next update required
    M_BEARER_NUPDATE_POS  = 5,
    M_BEARER_NUPDATE_BIT  = CO_BIT(M_BEARER_NUPDATE_POS),
};
