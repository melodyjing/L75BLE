...
enum mm_cfg_idx
{
    ...
    ///  ***********  Time Server *************
	  MM_CFG_IDX_TSCNS_MIN                = 70,
		
		MM_CFG_IDX_TSCNS_TIME               = MM_CFG_IDX_TSCNS_MIN,
		
		MM_CFG_IDX_TSCNS_SCENCE,
		
		MM_CFG_IDX_TSCNS_SCHDULE,
		
		MM_CFG_IDX_TSCNS_MAX               = MM_CFG_IDX_TSCNS_SCHDULE,
		
		    /// **************	Light LC   *******************
    MM_CFG_IDX_LIGHTS_LC,
...
enum mm_state_idx
{
    ...
    MM_STATE_LIGHT_XYL_XY_RANGE,
		...
		/// Time and Scenes Server		
		MM_STATE_TSCNS_TAI_SECONDS = 250,
		
		MM_STATE_TSCNS_ZONE_OFFSET,
		
		MM_STATE_TSCNS_ACTION_ON,
		
		MM_STATE_TSCNS_ACTION_OFF,
		
		MM_STATE_TSCNS_ACTION_SCENE,
		
		MM_STATE_TSCNS_SCENE_SAVE,    //保存当前场景
		
		MM_STATE_TSCNS_SCENE_DEL,    //		
		
		MM_STATE_TSCNS_SCENE_RECALL,
...
//////////////////////////////////// Tulips 命令		
		MM_STATE_TULIPXI_VENDOR_OTA,
		
		MM_STATE_TULIPXI_VENDOR_SCENS_SAVE,
		
		MM_STATE_TULIPXI_VENDOR_SCENS_DEL,
};
