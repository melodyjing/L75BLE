...
#define BLE_ADV_FRAG_NB_TX           (3)     //(5)  liujian 2019/12/6   (5)
/// Size of advertising or scan response data fragments in extended advertising PDU chain
#define BLE_ADV_FRAG_SIZE_TX         (150)     //(254)  120              (120)
...
#if (BLE_CIS || BLE_BIS)
#define BLE_EVT_MASK                {0xFD, 0xFF, 0x0F, 0x3F, 0x00, 0x00, 0x00, 0x00}
#else // !(BLE_CIS || BLE_BIS)
#define BLE_EVT_MASK                {0xFD, 0xFF, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00}
