...
enum SCH_FRAME_IRQ
{
    ...
    #if (BLE_HW_50_ISO == 0)
    /// Audio channel 0 ISR
    SCH_FRAME_IRQ_AUDIO_0    = 0x05,
    /// Audio channel 1 ISR
    SCH_FRAME_IRQ_AUDIO_1    = 0x06,
    /// Audio channel 2 ISR
    SCH_FRAME_IRQ_AUDIO_2    = 0x07,
...
struct sch_prog_params_ble
{
    ...
    /// Isochronous channel
    uint8_t isochan;
    /// Used to select Isochronous channel Buffer Pointer (0: Uses ISO TX/RX PTR0, 1: Uses ISO TX/RX PTR1)
    uint8_t isobufsel;
    #else
...
/**
 ****************************************************************************************
 * @brief Handle "AUDIO" interrupt
 *
 * @param[in] audio_channel Audio channel number that trigger an interrupt
 ****************************************************************************************
 */
void sch_prog_audio_isr(uint8_t audio_channel);
#else // (BLE_HW_50_ISO == 1)
/**
 ****************************************************************************************
...
/**
 ****************************************************************************************
 * @brief Handle Activity interrupt
 *
 * @param[in] state      Status bits of activity interrupt
 ****************************************************************************************
 */
void sch_prog_activity_isr(uint32_t state);
