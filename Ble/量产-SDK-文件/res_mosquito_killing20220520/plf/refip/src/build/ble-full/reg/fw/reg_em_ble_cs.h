 ...
 * </pre>
 */
#define EM_BLE_CNTL_ADDR   (0x40104000 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_LINK_ADDR   (0x40104002 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_THRCNTL_RATECNTL_ADDR   (0x40104004 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_LEBDADDR_ADDR   (0x40104006 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_SYNCWL_ADDR   (0x4010400C + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_SYNCWH_ADDR   (0x4010400E + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_CRCINIT0_ADDR   (0x40104010 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_CRCINIT1_ADDR   (0x40104012 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_FILTPOL_RALCNTL_ADDR   (0x40104014 + EM_BLE_CS_OFFSET)
...
#define EM_BLE_RAL_RESOL_EN_BIT      ((uint16_t)0x00000040)
#define EM_BLE_RAL_RESOL_EN_POS      6
...
__INLINE void em_ble_filtpol_ralcntl_pack(int elt_idx, uint8_t filterpolicy, uint8_t ralresolen, uint8_t adifiltmode, uint8_t adifilten, uint8_t peradvfilten, uint8_t localrpasel, uint8_t ralmode, uint8_t ralen)
{
    ASSERT_ERR((((uint16_t)filterpolicy << 8) & ~((uint16_t)0x0000FF00)) == 0);
    ASSERT_ERR((((uint16_t)ralresolen << 6) & ~((uint16_t)0x00000040)) == 0);
    ...
    EM_BLE_WR(EM_BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE,  ((uint16_t)filterpolicy << 8) | ((uint16_t)ralresolen << 6) | ((uint16_t)adifiltmode << 5) | ((uint16_t)adifilten << 4) | ((uint16_t)peradvfilten << 3) | ((uint16_t)localrpasel << 2) | ((uint16_t)ralmode << 1) | ((uint16_t)ralen << 0));
}

__INLINE void em_ble_filtpol_ralcntl_unpack(int elt_idx, uint8_t* filterpolicy, uint8_t* ralresolen, uint8_t* adifiltmode, uint8_t* adifilten, uint8_t* peradvfilten, uint8_t* localrpasel, uint8_t* ralmode, uint8_t* ralen)
{
    ...
    *ralresolen = (localVal & ((uint16_t)0x00000040)) >> 6;
...
{
    ASSERT_ERR((((uint16_t)ralresolen << 6) & ~((uint16_t)0x00000040)) == 0);
    EM_BLE_WR(EM_BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE, (EM_BLE_RD(EM_BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_EM_BLE_CS_SIZE) & ~((uint16_t)0x00000040)) | ((uint16_t)ralresolen << 6));
}
 ...
 * </pre>
 */
#define EM_BLE_HOPCNTL_ADDR   (0x40104016 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXRXCNTL_ADDR   (0x40104018 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXWINCNTL_ADDR   (0x4010401A + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXDESCPTR_ADDR   (0x4010401C + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_WINOFFSET_ADDR   (0x4010401E + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_MINEVTIME_ADDR   (0x4010401E + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_MAXEVTIME_ADDR   (0x40104020 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_CONNINTERVAL_ADDR   (0x40104022 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_CHMAP0_ADDR   (0x40104022 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_CHMAP1_ADDR   (0x40104024 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_CHMAP2_ADDR   (0x40104026 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXMAXBUF_ADDR   (0x40104028 + EM_BLE_CS_OFFSET)
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  15:11          MAXCHRXDESC   0x0
 *  10:00          MAXCHRXBYTE   0x0
 * </pre>
 */
#define EM_BLE_RXMAXAUXCHAIN_ADDR   (0x40104028 + EM_BLE_CS_OFFSET)
#define EM_BLE_RXMAXAUXCHAIN_INDEX  0x00000014
...
// field definitions
#define EM_BLE_MAXCHRXDESC_MASK   ((uint16_t)0x0000F800)
#define EM_BLE_MAXCHRXDESC_LSB    11
#define EM_BLE_MAXCHRXDESC_WIDTH  ((uint16_t)0x00000005)
#define EM_BLE_MAXCHRXBYTE_MASK   ((uint16_t)0x000007FF)
#define EM_BLE_MAXCHRXBYTE_LSB    0
#define EM_BLE_MAXCHRXBYTE_WIDTH  ((uint16_t)0x0000000B)

#define EM_BLE_MAXCHRXDESC_RST    0x0
#define EM_BLE_MAXCHRXBYTE_RST    0x0

__INLINE void em_ble_rxmaxauxchain_pack(int elt_idx, uint8_t maxchrxdesc, uint16_t maxchrxbyte)
{
    ASSERT_ERR((((uint16_t)maxchrxdesc << 11) & ~((uint16_t)0x0000F800)) == 0);
    ASSERT_ERR((((uint16_t)maxchrxbyte << 0) & ~((uint16_t)0x000007FF)) == 0);
    EM_BLE_WR(EM_BLE_RXMAXAUXCHAIN_ADDR + elt_idx * REG_EM_BLE_CS_SIZE,  ((uint16_t)maxchrxdesc << 11) | ((uint16_t)maxchrxbyte << 0));
}

__INLINE void em_ble_rxmaxauxchain_unpack(int elt_idx, uint8_t* maxchrxdesc, uint16_t* maxchrxbyte)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXMAXAUXCHAIN_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);

    *maxchrxdesc = (localVal & ((uint16_t)0x0000F800)) >> 11;
    *maxchrxbyte = (localVal & ((uint16_t)0x000007FF)) >> 0;
}

__INLINE uint8_t em_ble_rxmaxauxchain_maxchrxdesc_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXMAXAUXCHAIN_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000F800)) >> 11);
}

__INLINE void em_ble_rxmaxauxchain_maxchrxdesc_setf(int elt_idx, uint8_t maxchrxdesc)
{
    ASSERT_ERR((((uint16_t)maxchrxdesc << 11) & ~((uint16_t)0x0000F800)) == 0);
    EM_BLE_WR(EM_BLE_RXMAXAUXCHAIN_ADDR + elt_idx * REG_EM_BLE_CS_SIZE, (EM_BLE_RD(EM_BLE_RXMAXAUXCHAIN_ADDR + elt_idx * REG_EM_BLE_CS_SIZE) & ~((uint16_t)0x0000F800)) | ((uint16_t)maxchrxdesc << 11));
}

__INLINE uint16_t em_ble_rxmaxauxchain_maxchrxbyte_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXMAXAUXCHAIN_ADDR + elt_idx * REG_EM_BLE_CS_SIZE);
    return ((localVal & ((uint16_t)0x000007FF)) >> 0);
}

__INLINE void em_ble_rxmaxauxchain_maxchrxbyte_setf(int elt_idx, uint16_t maxchrxbyte)
{
    ASSERT_ERR((((uint16_t)maxchrxbyte << 0) & ~((uint16_t)0x000007FF)) == 0);
    EM_BLE_WR(EM_BLE_RXMAXAUXCHAIN_ADDR + elt_idx * REG_EM_BLE_CS_SIZE, (EM_BLE_RD(EM_BLE_RXMAXAUXCHAIN_ADDR + elt_idx * REG_EM_BLE_CS_SIZE) & ~((uint16_t)0x000007FF)) | ((uint16_t)maxchrxbyte << 0));
}
 ...
 * </pre>
 */
#define EM_BLE_RXMAXTIME_ADDR   (0x4010402A + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_SK_ADDR   (0x4010402C + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_ADV_BD_ADDR_ADDR   (0x4010402C + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_PEER_RALPTR_ADDR   (0x4010402C + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_ADV_BD_ADDR_TYPE_ADDR   (0x40104032 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_AUXTXDESCPTR_ADDR   (0x40104034 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_IV_ADDR   (0x4010403C + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_WINOFFSET_2M_ADDR   (0x40104036 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_CONNINTERVAL_2M_ADDR   (0x40104038 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_WINOFFSET_LR_ADDR   (0x4010403A + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_CONNINTERVAL_LR_ADDR   (0x4010403C + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXWINOFFSET_ADDR   (0x40104044 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXCCMPKTCNT0_ADDR   (0x40104044 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_EXTADVSTAT_ADDR   (0x40104046 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXCCMPKTCNT1_ADDR   (0x40104046 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXCCMPKTCNT2_ADDR   (0x40104048 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXCCMPKTCNT0_ADDR   (0x4010404A + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXCCMPKTCNT1_ADDR   (0x4010404C + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_RXCCMPKTCNT2_ADDR   (0x4010404E + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_EVTCNT_ADDR   (0x40104050 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_ADI_ADDR   (0x40104052 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_ISOTXRXCNTL_ADDR   (0x40104054 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_TXRXDESCCNT_ADDR   (0x40104056 + EM_BLE_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BLE_ISOTXRXPKTCNT_ADDR   (0x40104058 + EM_BLE_CS_OFFSET)
