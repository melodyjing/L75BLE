...
#define BLE_PREFETCH_TIME_US       (110)
#endif // (BLE_HW_50_ISO == 0)
#define BT_PREFETCH_TIME_US       (125)
...
#else // (BLE_HW_50_ISO == 1)
#define BLE_PREFETCHABORT_TIME_US  (140)
#endif // (BLE_HW_50_ISO == 0)
#define BT_PREFETCHABORT_TIME_US  (155)
...
//	
//#if COBRA_ECC_EN
//	  KE_EVENT_ECC_END,      //liujian add 2019/5/30
//#endif
//	
...
//#if COBRA_AES_EN
//		COBRA4_KE_EVENT_AES_END,
//#endif	
//	
//#if COBRA4_SM4_EN
//		COBRA4_KE_EVENT_SM4_END,
//#endif
...
enum PARAM_ID
{
    ...
    PARAM_ID_PROG_DELAY                 = 0x10,

    /// Enable/disable channel assessment for BT and/or BLE
    PARAM_ID_CH_ASS_EN                  = 0x11,

    /// Synchronous links configuration
    PARAM_ID_SYNC_CONFIG                = 0x12,
    /// PCM Settings
    PARAM_ID_PCM_SETTINGS               = 0x13,
    /// Sleep algorithm duration
    PARAM_ID_SLEEP_ALGO_DUR             = 0x14,
    /// Tracer configuration
    PARAM_ID_TRACER_CONFIG              = 0x15,

    /// Diagport configuration
    PARAM_ID_DIAG_BT_HW                 = 0x16,
    PARAM_ID_DIAG_BLE_HW                = 0x17,
    PARAM_ID_DIAG_SW                    = 0x18,
    PARAM_ID_DIAG_DM_HW                 = 0x19,
    PARAM_ID_DIAG_PLF                   = 0x1A,

    /// IDC selection (for audio demo)
    PARAM_ID_IDCSEL_PLF                 = 0x1B,

    /// RSSI threshold tags
    PARAM_ID_RSSI_HIGH_THR              = 0x1C,
    PARAM_ID_RSSI_LOW_THR               = 0x1D,
    PARAM_ID_RSSI_INTERF_THR            = 0x1E,

    /// RF BTIPT
    PARAM_ID_RF_BTIPT_VERSION          = 0x1F,
    PARAM_ID_RF_BTIPT_XO_SETTING       = 0x20,

    PARAM_ID_BT_LINK_KEY_FIRST          = 0x21,
    PARAM_ID_BT_LINK_KEY_LAST           = 0x22,

    PARAM_ID_BLE_LINK_KEY_FIRST         = 0x23,
    PARAM_ID_BLE_LINK_KEY_LAST          = 0x24,
    /// SC Private Key (Low Energy)
    PARAM_ID_LE_PRIVATE_KEY_P256        = 0x25,
    /// SC Public Key (Low Energy)
    PARAM_ID_LE_PUBLIC_KEY_P256         = 0x26,
    /// SC Debug: Used Fixed Private Key from NVDS (Low Energy)
    PARAM_ID_LE_DBG_FIXED_P256_KEY      = 0x27,
    /// SP Private Key (classic BT)
    PARAM_ID_SP_PRIVATE_KEY_P256        = 0x28,
    /// SP Public Key (classic BT)
    PARAM_ID_SP_PUBLIC_KEY_P256         = 0x29,

    /// LE Coded PHY 500 Kbps selection
    PARAM_ID_LE_CODED_PHY_500           = 0x2A,
