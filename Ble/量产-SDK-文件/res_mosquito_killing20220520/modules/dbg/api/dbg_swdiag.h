...
enum dbg_swdiag
{
    ...
    */
    ...
    DBG_SWDIAG_IP_ISR_TGTTIMER_OFFSET          = 6,
    DBG_SWDIAG_IP_ISR_TGTTIMER_MASK            = 0x40,

    DBG_SWDIAG_IP_ISR_FIFO_OFFSET              = 7,
    DBG_SWDIAG_IP_ISR_FIFO_MASK                = 0x80,
	...
	*/
    ...
    DBG_SWDIAG_CI_RX_ISO_OFFSET                      = 3,
    DBG_SWDIAG_CI_RX_ISO_MASK                        = 0x08,

    DBG_SWDIAG_CI_TX_ISO_OFFSET                      = 4,
    DBG_SWDIAG_CI_TX_ISO_MASK                        = 0x10,

    DBG_SWDIAG_CI_CANCEL_OFFSET                      = 5,
    DBG_SWDIAG_CI_CANCEL_MASK                        = 0x20,

    DBG_SWDIAG_CI_PROG_OFFSET                        = 6,
    DBG_SWDIAG_CI_PROG_MASK                          = 0x40,

    DBG_SWDIAG_CI_SKIP_OFFSET                        = 7,
    DBG_SWDIAG_CI_SKIP_MASK                          = 0x80,

    /**
     ******************************************************************************************
     * @brief BANK 43 : CI Data Driver
     ******************************************************************************************
     */
