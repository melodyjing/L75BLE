...
LOCAL UINT device2_is_connected;
...
void app_connetion_device2_rx_data(struct uart_client_rx_data_ind  CONST *param)
{
	    UINT8 * p_data;
			...
			if(connection_devive2_env.receive_begin == 0)
			{
					...
					{
							 p_data += 1;
							 connection_devive2_env.need_data_number += 1;
					}	
...
//void app_device2_set_pincode(UINT code)
//{
//	connection_devive2_env.connection_pin_code = code;
//}

//UINT app_device2_get_pincode(void)
//{
//	return connection_devive2_env.connection_pin_code; 
//}

//void app_device2_set_pair_flag(UCHAR flag)
//{
//	connection_devive2_env.connection_pair_flag = flag;
//}

//UINT app_device2_get_pair_flag(void)
//{
