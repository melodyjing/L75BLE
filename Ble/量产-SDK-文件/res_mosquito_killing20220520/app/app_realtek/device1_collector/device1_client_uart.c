...
LOCAL UINT8  device1_uart_client_init(struct prf_task_env* env, uint16_t* start_hdl, uint16_t app_task, UINT8 sec_lvl,  void* params)
{
		UINT8 idx;
...
LOCAL void device1_uart_client_cleanup(struct prf_task_env* env, UINT8 conidx, UINT8 reason)
{
...
LOCAL void device1_uart_client_destroy(struct prf_task_env* env)
{
    UINT8 idx;
    struct device1_uart_client_env_tag* device1_uart_env = (struct device1_uart_client_env_tag*) env->env;
...
LOCAL void device1_uart_client_create(struct prf_task_env* env, UINT8 conidx)
{
