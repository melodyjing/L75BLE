...
************************************************************************/
#if (BLE_HOST2_UART  && DIANBIAO_PROTOCOL_REALTEK_ENABLE)
...
LOCAL INT app_host2_uart_msg_handler(ke_msg_id_t CONST msgid,
                              void CONST *param,
...
LOCAL INT app_host2_uart_cfg_indntf_ind_handler(ke_msg_id_t CONST msgid,
...
LOCAL INT app_host2_uart_rx_handler(ke_msg_id_t CONST msgid,
...
LOCAL INT app_host2_uart_enable_rsp(ke_msg_id_t CONST msgid,
                              void CONST *param,
                              ke_task_id_t CONST dest_id,
                              ke_task_id_t CONST src_id)
{
...
LOCAL INT app_host2_uart_send_rsp(ke_msg_id_t CONST msgid,
                              void CONST *param,
                              ke_task_id_t CONST dest_id,
                              ke_task_id_t CONST src_id)
{
...
void realtek_handle_host_data(struct sch_realtek_rece_elt_tag * elt)
{
	    ...
	    printf("realtek_handle_host_data elt->conidx = %d %d %d\n", elt->conidx,app_host_env_1.connection_index,app_host_env_2.connection_index);

			if(elt->conidx == app_host_env_1.connection_index)
			{
					//printf("app_host_env_1.connection_index = %d \n", app_host_env_1.connection_index);
					p_data = elt->rx_data;
...
//							}
							...
							memcpy(app_host_env_1.receive_data + app_host_env_1.receive_index, elt->rx_data, elt->length);
							
							app_host_env_1.receive_index += elt->length;
							
							app_host_env_1.need_data_number -= elt->length;
					}
					else
					{
							memcpy(app_host_env_1.receive_data + app_host_env_1.receive_index, elt->rx_data, elt->length);
		...
		printf("app_host_env_1.receive_begin = %d %d\n", app_host_env_1.receive_begin,app_host_env_1.need_data_number);			
			...
			else if(elt->conidx == app_host_env_2.connection_index)
			{
					printf("app_host_env_2.connection_index = %d \n", app_host_env_2.connection_index);
					p_data = elt->rx_data;
...
//							}
							...
							memcpy(app_host_env_2.receive_data + app_host_env_2.receive_index, elt->rx_data, elt->length);
							
							app_host_env_2.receive_index += elt->length;
							
							app_host_env_2.need_data_number -= elt->length;
					}
					else
					{
							memcpy(app_host_env_2.receive_data + app_host_env_2.receive_index, elt->rx_data, elt->length);
