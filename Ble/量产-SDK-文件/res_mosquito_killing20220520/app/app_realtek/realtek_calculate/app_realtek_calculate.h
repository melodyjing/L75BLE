/******************************************************************************
	...
	File Name	:	app_realtek_calculate.h
	Version		:	0.1
	Created	By	:	LiuJian
	Date		:	2019/12/17
...
*****************************************************************************/
#ifndef __APP_REALTEK_CALCULATE_H__
#define __APP_REALTEK_CALCULATE_H__

#if(BLE_DIANBIAO_CALCUALTE_ENABLE  && DIANBIAO_PROTOCOL_REALTEK_ENABLE)
...
//void app_iris_calculate_send_task(APP_CAL_FREQUENCY *p_cal_param, UINT address, UCHAR pluse_type);

//void app_iris_calculate_receive_task(APP_CAL_FREQUENCY *p_cal_param, UINT address, UCHAR pluse_type);

int app_iris_calculate_init(UINT frequency);
void app_csem_pluse_calculate_init(void);
UINT app_iris_set_frequency(USHORT frequency);
void app_iris_set_access_address(UINT address);
void app_iris_set_whitelist_value(USHORT frequency);
