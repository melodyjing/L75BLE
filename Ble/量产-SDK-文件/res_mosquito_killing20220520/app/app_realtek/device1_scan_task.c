...
LOCAL INT app_scan_device1_gapm_activity_created_ind_handler(ke_msg_id_t CONST msgid,
...
LOCAL INT app_scan_device1_gapm_cmp_evt_handler(ke_msg_id_t CONST msgid,
                                struct gapm_cmp_evt CONST *param,
                                ke_task_id_t CONST dest_id,
                                ke_task_id_t CONST src_id)
{
//			printf("scan device1 operation = %d \n", param->operation);
