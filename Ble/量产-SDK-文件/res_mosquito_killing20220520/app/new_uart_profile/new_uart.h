...
* <tr><td>2019/04/09  <td>1.0      <td>liujian   <td>创建初始版本
* </table>
*
**********************************************************************************
*/
...
#define UART_HANDLE(idx) (uart_att_hdl_get(uart_env, (idx)))

#define UART_IDX(hdl) (uart_att_idx_get(uart_env, (hdl)))
 ...
 ****************************************************************************************
 */
uint16_t uart_att_hdl_get(struct uart_env_tag *htpt_env, uint8_t att_idx);
 ...
 ****************************************************************************************
 */
uint8_t uart_att_idx_get(struct uart_env_tag *htpt_env, uint16_t handle);
