...
*****************************************************************************/
#ifndef __APP_WIRELESS_MCU_H__
#define __APP_WIRELESS_MCU_H__
...
typedef void (*p_csem_rf_receive)(unsigned char *p_buffer, unsigned char length);

typedef void (*p_csem_rf_send_callback)(unsigned char state,  unsigned char ack_length, unsigned char *ack_data);

#define MAX_PAYLOAD_SIZE  64
typedef struct {
		unsigned char payload_length;
		unsigned char payload_pid;
		unsigned char payload_no_ack;
...
//		unsigned char ch;
//		unsigned int  sync;
//		p_csem_rf_receive  receive_function;	
//}receive_type;
...
//void app_csem_receive_setting(unsigned char ch, unsigned int sync_word, p_csem_rf_receive function);
...
int app_csem_send_setting(unsigned char *p_buffer, unsigned char length, \
