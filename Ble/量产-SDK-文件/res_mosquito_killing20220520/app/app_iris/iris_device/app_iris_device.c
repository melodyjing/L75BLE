...
//让 server 可以上报数据
void app_iris_device_enable_report(uint8_t conidx)
{
...
static int app_iris_device_msg_handler(ke_msg_id_t const msgid,
                              void const *param,
...
static int app_iris_device_connection_handler(ke_msg_id_t const msgid,
...
static int app_iris_device_rx_handler(ke_msg_id_t const msgid,
...
static int app_iris_device_cmp_handler(ke_msg_id_t const msgid,
