/******************************************************************************
	File Name	:	host_advertiser_task1.c
	Version		:	0.1
	Created	By	:	LiuJian
	Date		:	2019/11/20
...
static uint8_t app_device1_get_handler(const struct app_subtask_handlers *handler_list_desc,
                               ke_msg_id_t msgid,
                               void *param,
                               ke_task_id_t src_id)
{
    ...
    for (counter = handler_list_desc->msg_cnt; 0 < counter; counter--)
    {
            ...
            (handler.id == KE_MSG_DEFAULT_HANDLER))
        {
            ...
            return (uint8_t)(handler.func(msgid, param, TASK_ADV_DEVICE1, src_id));
        }
    }
...
/////消息处理函数 
static int app_device1_msg_handler(ke_msg_id_t const msgid,
                            void *param,
...
////&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
///**********************************************GAPC message ******************************************************************
static int app_device1_gapc_get_dev_info_req_ind_handler(ke_msg_id_t const msgid,
...
static int app_device1_gapc_set_dev_info_req_ind_handler(ke_msg_id_t const msgid,
...
static int app_device1_gapc_connection_req_ind_handler(ke_msg_id_t const msgid,
...
static int app_device1_gapc_cmp_evt_handler(ke_msg_id_t const msgid,
...
static int app_device1_gapc_disconnect_ind_handler(ke_msg_id_t const msgid,
...
static int app_device1_gapm_gen_rand_nb_ind_handler(ke_msg_id_t const msgid, struct gapm_gen_rand_nb_ind *param,
...
static int app_device1_gapm_activity_created_ind_handler(ke_msg_id_t const msgid,
...
static int app_device1_gapm_activity_stopped_ind_handler(ke_msg_id_t const msgid,
...
static int app_device1_gapm_profile_added_ind_handler(ke_msg_id_t const msgid,
...
static int app_device1_gapm_cmp_evt_handler(ke_msg_id_t const msgid,
