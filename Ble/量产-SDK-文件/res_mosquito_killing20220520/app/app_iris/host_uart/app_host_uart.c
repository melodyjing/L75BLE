...
#if((BLE_HOST_UART  == 1) && (DIANBIAO_PROTOCOL_ZHENGTAI_ENABLE == 1))
...
static int app_host_uart_msg_handler(ke_msg_id_t const msgid,
                              void const *param,
...
static int app_host_uart_cfg_indntf_ind_handler(ke_msg_id_t const msgid,
...
static int app_host_uart_rx_handler(ke_msg_id_t const msgid,
                                        ...
                                        ke_task_id_t const src_id)
{
	    ...
	    //printf("app_host_uart_rx_handler param->length = %d \n", param->length);
			if(param->conidx == app_host_env_1.connection_index)
			{
...
static int app_host_uart_enable_rsp(ke_msg_id_t const msgid,
                              void const *param,
                              ke_task_id_t const dest_id,
                              ke_task_id_t const src_id)
{  
...
static int app_host_uart_send_rsp(ke_msg_id_t const msgid,
                              void const *param,
                              ke_task_id_t const dest_id,
                              ke_task_id_t const src_id)
{
