...
#ifndef __COBRA_SIXTIMER_H__
#define __COBRA_SIXTIMER_H__
...
typedef struct cobra_dualtimer_both_type
{
...
typedef struct cobra_dualtimer_single_type
{
...
}COBRA_DUALTIMER_SINGLE_TypeDef;
...
typedef enum {
	COUNT_16BIT,
	COUNT_32BIT
}DUALTIMER_COUNT_SIZE;

typedef enum {
	DUALTIME_FREE_RUNNING,
	DUALTIME_PERIODIC,
	DUALTIME_ONE_SHOT
}DUALTIME_MODE;
...
void cobra_dualtimer_interrupt_function(void);




#define COBRA_DUALTIMER_BASE				(0x400C9000UL)

#define COBRA_DUALTIMER_1_BASE  (COBRA_DUALTIMER_BASE)
#define COBRA_DUALTIMER_2_BASE  (COBRA_DUALTIMER_BASE + 0x20UL)

#define COBRA_DUALTIMER20_BASE				(0x40086000UL)

#define COBRA_DUALTIMER20_1_BASE  (COBRA_DUALTIMER20_BASE)
#define COBRA_DUALTIMER20_2_BASE  (COBRA_DUALTIMER20_BASE + 0x20UL)
