/******************************************************************************
	...
	File Name	:	cobra4A_link_config.h
	Version		:	0.1
	Created	By	:	LiuJian
	Date		:	2020/8/10

	Description :   
      This file contains all the necessary definitions
...
*****************************************************************************/
#ifndef __COBRA4A_LINK_CONFIG_H__
#define __COBRA4A_LINK_CONFIG_H__
...
*/
#define ListMemAlloc(Mem)						  cobra4_malloc(Mem)

/**
	*The method used for freeing up memory.
*/
#define ListMemDealloc(Mem)						cobra4_free(Mem)
