 ...
 ******************************************************************************/
  ...
  #define __INLINE_ARM         __inline                                   /*!< inline keyword for ARM Compiler       */
 ...
 * Return the content of the base priority register
 */
static __INLINE_ARM uint32_t  __get_BASEPRI(void)
{
  register uint32_t __regBasePri         __ASM("basepri");
  return(__regBasePri);
}
 ...
 * Set the base priority register
 */
static __INLINE_ARM void __set_BASEPRI(uint32_t basePri)
{
  register uint32_t __regBasePri         __ASM("basepri");
 ...
 * Return state of the priority mask bit from the priority mask register
 */
static __INLINE_ARM uint32_t __get_PRIMASK(void)
{
 ...
 * Set the priority mask bit in the priority mask register
 */
static __INLINE_ARM void __set_PRIMASK(uint32_t priMask)
{
  register uint32_t __regPriMask         __ASM("primask");
 ...
 * Return the content of the fault mask register
 */
static __INLINE_ARM uint32_t __get_FAULTMASK(void)
{
 ...
 * Set the fault mask register
 */
static __INLINE_ARM void __set_FAULTMASK(uint32_t faultMask)
{
  register uint32_t __regFaultMask       __ASM("faultmask");
 ...
 * Return the content of the control register
 */
static __INLINE_ARM uint32_t __get_CONTROL(void)
{
 ...
 * Set the control register
 */
static __INLINE_ARM void __set_CONTROL(uint32_t control)
{
  register uint32_t __regControl         __ASM("control");
 ...
 */
static __INLINE_ARM void NVIC_SetPriorityGrouping(uint32_t PriorityGroup)
{
  uint32_t reg_value;
 ...
 */
static __INLINE_ARM uint32_t NVIC_GetPriorityGrouping(void)
{
 ...
 */
static __INLINE_ARM void NVIC_EnableIRQ(IRQn_Type IRQn)
{
 ...
 * The interrupt number cannot be a negative value.
 */
static __INLINE_ARM void NVIC_DisableIRQ(IRQn_Type IRQn)
{
 ...
 */
static __INLINE_ARM uint32_t NVIC_GetPendingIRQ(IRQn_Type IRQn)
{
 ...
 * The interrupt number cannot be a negative value.
 */
static __INLINE_ARM void NVIC_SetPendingIRQ(IRQn_Type IRQn)
{
 ...
 * The interrupt number cannot be a negative value.
 */
static __INLINE_ARM void NVIC_ClearPendingIRQ(IRQn_Type IRQn)
{
 ...
 * otherwise it returns 0.
 */
static __INLINE_ARM uint32_t NVIC_GetActive(IRQn_Type IRQn)
{
 ...
 */
static __INLINE_ARM void NVIC_SetPriority(IRQn_Type IRQn, uint32_t priority)
{
  if(IRQn < 0) {
 ...
 * Note: The priority cannot be set for every core interrupt.
 */
static __INLINE_ARM uint32_t NVIC_GetPriority(IRQn_Type IRQn)
{
 ...
 */
static __INLINE_ARM uint32_t NVIC_EncodePriority (uint32_t PriorityGroup, uint32_t PreemptPriority, uint32_t SubPriority)
{
  uint32_t PriorityGroupTmp = (PriorityGroup & 0x07);          /* only values 0..7 are used          */
 ...
 */
static __INLINE_ARM void NVIC_DecodePriority (uint32_t Priority, uint32_t PriorityGroup, uint32_t* pPreemptPriority, uint32_t* pSubPriority)
{
  uint32_t PriorityGroupTmp = (PriorityGroup & 0x07);          /* only values 0..7 are used          */
  uint32_t PreemptPriorityBits;
  uint32_t SubPriorityBits;
 ...
 */
static __INLINE_ARM uint32_t SysTick_Config(uint32_t ticks)
{ 
 ...
 */
static __INLINE_ARM void NVIC_SystemReset(void)
{
 ...
 */
static __INLINE_ARM uint32_t ITM_SendChar (uint32_t ch)
{
 ...
 * It is blocking when a debugger is connected, but the previous character send is not transmitted. 
 */
static __INLINE_ARM int ITM_ReceiveChar (void) {
 ...
 */
static __INLINE_ARM int ITM_CheckChar (void) {
