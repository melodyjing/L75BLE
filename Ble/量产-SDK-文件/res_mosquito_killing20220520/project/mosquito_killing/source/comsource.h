...
#define DEVICE_NAME                          "WechatBle"                              /**< Name of device. Will be included in the advertising data. */
...
#define RX_PIN_NUMBER  11 //串口RXD
#define TX_PIN_NUMBER  9 //串口TXD
#define LED0 20            //广播指示灯，默认蓝色
#define SYS_RESET 19      //复位按键K2
